...
export default function Search() {
  ...
  return (
    <>
      <div className=' w-full flex  justify-between items-center  md:px-6 lg:px-10 md:pb-2 pt-6'>
        ...
        <div className='  md:justify-end justify-around md:z-0 z-[1000] flex md:py-0 py-2 sm:pr-32 md:pr-0  md:relative fixed bottom-0 md:bg-inherit bg-[#191919] w-full gap-7 items-center md:flex-[.25] flex-1 '>
